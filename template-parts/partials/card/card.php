...
<article id="post-<?php echo $args["ID"] ?>" class="card bg-white h-100">
    <div class="echo-lazy bg card-image" alt="<?php echo $args['title'] ?>" data-bg="true" data-src="<?php echo $args['image'] ?>"></div>
    <div class="d-flex flex-wrap align-items-center justify-content-between h-100 card-content text-center py-4">
        ...
        <div class="d-flex align-items-center justify-content-center py-3 fw-600">
            <div class="rounded-circle card-author bg echo-lazy me-1" data-bg="true" data-src="<?php echo $args["author"]["avatar"] ?>" ></div>
            <small><?php echo $args["author"]["name"] ?></small>
            <small class="sep px-1">|</small>
            <small><?php echo $args["date"] ?></small>
        </div>
    </div>
